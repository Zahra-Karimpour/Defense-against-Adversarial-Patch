...
parser.add_argument('--data_dir', type=str, default='./data', help='imagenet directory')

parser.add_argument('--plot_all', type=int, default=1, help='1 == plot all successful adversarial images')

parser.add_argument('--netClassifier', default='alexnet', help="The target classifier")
...
train_loader = torch.utils.data.DataLoader(dataset=
    dset.ImageNet(root=opt.data_dir, split='val',download=True ,transform=
    transforms.Compose([
